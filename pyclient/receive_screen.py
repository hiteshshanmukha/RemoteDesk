...
class ReceiveScreen(threading.Thread):
    ...
    def __init__(self, client_socket, display_panel, buffer_size=3, server_ip=None, server_port=None):
        """
    ...
    def _reconnect(self):
        ...
        # Cannot reconnect because we don't have server info
        self.logger.error("Reconnection not possible - missing server information")
        return False
